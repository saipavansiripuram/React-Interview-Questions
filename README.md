...
18. [How does data flow & what are "props" and "state" ?](#how-does-data-flow-&-what-are-props-and-state-)
19. [Differentiate Between Server & Client Side Rendering?](#differentiate-between-server-&-client-side-rendering-)
